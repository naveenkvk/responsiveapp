...
const Calendar: React.FC = () => {
  ...
  const sampleEvents: CalendarEvent[] = [
    ...
    {
      id: '4',
      title: 'Private Equity Conference 2025',
    ...
    },
    {
      ...
      endDate: new Date('2025-11-05T12:30:00'),
      type: 'meeting',
      location: 'Virtual Meeting',
    ...
    },
    {
      ...
      description: 'Deadline for submitting K-1 tax forms for 2024 tax year.',
      date: new Date('2025-11-15T23:59:00'),
      type: 'deadline',
      isReminder: true,
    ...
    },
    {
      ...
      endDate: new Date('2025-09-18T16:00:00'),
      type: 'webinar',
      location: 'Virtual',
      isReminder: true,
      reminderTime: 120,
